                ...
                <div className={classes.QuizWrapper}>
                    ...
                    {this.props.loading === null
                        ...
                        : this.props.isFinished
                            ...
                            />
                            : <ActiveQuiz
                                answers={this.props.quizItems[this.props.activeQuestion].answers}
                                question={this.props.quizItems[this.props.activeQuestion].question}
                                quizLength={this.props.quizItems.length}
...
function mapStateToProps(state) {
    return {
        ...
        quizItems: state.quizes.quizItems,
